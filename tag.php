<?php
/**
 * Tag Archive Template for Wasla Educational Site
 * Displays posts from a specific tag with Wasla styling
 * 
 * @package Wasla
 * @since 1.0.0
 */
            ...
            <div class="wasla-container">
                ...
                <div class="tag-header">
                    ...
                    <div class="tag-meta">
                        ...
                        <?php if (function_exists('wasla_get_tag_views')) : ?>
                            <div class="tag-views">
                                <i class="bi bi-eye"></i>
                                <?php echo wasla_get_tag_views(get_queried_object_id()); ?> مشاهدة
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <section class="tag-content">
            <div class="wasla-container">
                <div class="tag-layout">
                    <!-- Main Posts Column -->
                    <main class="tag-posts" role="main">
                        ...
                        <div class="tag-posts-grid">
                            ...
                            ?>
                                <article class="tag-post-card" itemscope itemtype="https://schema.org/Article">
                                    <!-- Post Image -->
                    ...
                    <!-- Tag Sidebar -->
                    <aside class="tag-sidebar" role="complementary">
                        <!-- Search Widget -->
                        <div class="sidebar-widget search-widget">
                            <h3 class="widget-title">
                                <i class="bi bi-search"></i>
                                البحث في مقالات <?php single_tag_title(); ?>
                            </h3>
                            <form role="search" method="get" class="tag-search-form" action="<?php echo home_url('/'); ?>">
                                <div class="search-input-group">
                                    <input type="search" 
                                           class="search-input" 
                                           placeholder="ابحث في هذه الكلمة المفتاحية..." 
                                           value="<?php echo get_search_query(); ?>" 
                                           name="s">
                                    <input type="hidden" name="tag" value="<?php echo single_tag_title('', false); ?>">
                        ...
                        <div class="sidebar-widget tags-widget">
                            ...
                            <div class="tags-cloud">
                                ...
                                if ($tags) :
                                    ...
                                    <p class="no-tags">لا توجد كلمات مفتاحية أخرى</p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget categories-widget">
                            ...
                            <ul class="categories-list">
                                ...
                                if ($categories) :
                                    ...
                                    <li class="no-categories">لا توجد تصنيفات</li>
                                <?php endif; ?>
                            </ul>
                        </div>

                        <!-- Popular Posts with Same Tag -->
                        <div class="sidebar-widget popular-posts-widget">
                            <h3 class="widget-title">
                                <i class="bi bi-fire"></i>
                                الأكثر قراءة في <?php single_tag_title(); ?>
                            </h3>
                        ...
                        <div class="sidebar-widget related-articles-widget">
                            ...
                            <ul class="related-articles-list">
                                ...
                                if ($related_posts->have_posts()) :
                                    ...
                                    <li class="no-related-articles">لا توجد مقالات مقترحة</li>
                                <?php endif; ?>
                            </ul>
                        </div>
        ...
        <section class="no-posts-section">
            <div class="wasla-container">
                <div class="no-posts-content">
                    ...
                    <h1 class="no-posts-title">لا توجد مقالات بهذه الكلمة المفتاحية</h1>
                    <p class="no-posts-description">
                        عذراً، لا توجد مقالات منشورة بكلمة "<?php single_tag_title(); ?>" حالياً.
                    </p>
...
/* Focus styles */
.tag-post-card:focus-within,
.sidebar-widget a:focus,
.tag-pagination a:focus {
...
.tag-post-card:nth-child(1) { animation-delay: 0.1s; }
.tag-post-card:nth-child(2) { animation-delay: 0.2s; }
.tag-post-card:nth-child(3) { animation-delay: 0.3s; }
.tag-post-card:nth-child(4) { animation-delay: 0.4s; }
.tag-post-card:nth-child(5) { animation-delay: 0.5s; }
